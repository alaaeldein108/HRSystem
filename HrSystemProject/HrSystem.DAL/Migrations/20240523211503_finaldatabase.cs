        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkHours = table.Column<int>(type: "int", nullable: true, computedColumnSql: "DATEDIFF(HOUR, CheckInTime, ISNULL(CheckOutTime, CURRENT_TIMESTAMP))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceDays = table.Column<int>(type: "int", nullable: true),
                    AbsentDays = table.Column<int>(type: "int", nullable: true),
                    TotalOverTimeHours = table.Column<int>(type: "int", nullable: true),
                    TotalDiscountHours = table.Column<int>(type: "int", nullable: true),
                    TotalExtra = table.Column<decimal>(type: "money", nullable: true),
                    TotalDiscount = table.Column<decimal>(type: "money", nullable: true),
                    TotalSalary = table.Column<decimal>(type: "money", nullable: false),
