...
namespace HrSystem.DAL.Migrations
{
    ...
    [Migration("20240627181506_ApplicationRoleModifcation")]
    partial class ApplicationRoleModifcation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrSystem.DAL.Entities.ApplicationRole", b =>
                {
                    b.HasOne("HrSystem.DAL.Entities.ApplicationUser", "CreationRoles")
                        .WithMany()
                        .HasForeignKey("CreatorId");

                    b.HasOne("HrSystem.DAL.Entities.ApplicationUser", "ModificarionRoles")
                        .WithMany()
                        .HasForeignKey("ModifiedBy");

                    b.Navigation("CreationRoles");

                    b.Navigation("ModificarionRoles");
                });

            modelBuilder.Entity("HrSystem.DAL.Entities.ApplicationUser", b =>
                {
                    b.HasOne("HrSystem.DAL.Entities.ApplicationUser", "CreationUsers")
                        .WithMany()
                        .HasForeignKey("CreatorId");

                    b.HasOne("HrSystem.DAL.Entities.ApplicationUser", "ModificarionUsers")
                        .WithMany()
                        .HasForeignKey("ModifiedBy");

                    b.Navigation("CreationUsers");

                    b.Navigation("ModificarionUsers");
                });
